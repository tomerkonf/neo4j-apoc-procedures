...
Since APOC relies in some places on Neo4j's internal APIs you need to use the *matching APOC version* for your Neo4j installation.
...
| http://github.com/neo4j-contrib/neo4j-apoc-procedures/releases/4.0.0.16[4.0.0.16^] | 4.0.5 (4.0.x)
